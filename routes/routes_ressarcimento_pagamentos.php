...
Route::prefix('ressarcimento_pagamentos')->group(function () {
    ...
    Route::put('/{id}', [RessarcimentoPagamentoController::class, 'update'])->name('ressarcimento_pagamentos.update');
    ...
    Route::post('/importar', [RessarcimentoPagamentoController::class, 'importar'])->name('ressarcimento_pagamentos.importar');
});
