...
const executar_dashboard6 = () => new Promise((resolve, reject) => {
    dashboard6();
    resolve();
});

const executar_dashboard7 = () => new Promise((resolve, reject) => {
    dashboard7();
    resolve();
});

const executar_dashboard8 = () => new Promise((resolve, reject) => {
    dashboard8();
    resolve();
});

const executar_dashboard9 = () => new Promise((resolve, reject) => {
    dashboard9();
    resolve();
});

const executar_dashboard10 = () => new Promise((resolve, reject) => {
    dashboard10();
    resolve();
});

const executar_dashboard11 = () => new Promise((resolve, reject) => {
    dashboard11();
    resolve();
});

async function montarGraficos() {
    await executar_dashboard6();
    await executar_dashboard7();
    await executar_dashboard8();
    await executar_dashboard9();
    await executar_dashboard10();
    await executar_dashboard11();
}
...
function dashboard7() {
    ...
    return new Promise(function(resolve, reject) {
        ...
        var titulo = dashboard_name+' ('+getReferencia(1, $('#periodo1').val())+' até '+getReferencia(1, $('#periodo2').val())+')';
