...
@section('title') Quantitativos @endsection
...
@section('content')
                                    ...
                                    <div class="col-12 col-md-6 float-end">
                                        @php
                                            $selectCampoPesquisar = [
                                                ['value' => 'alimentacao_quantitativos.name', 'descricao' => 'Quantitativo']
                                            ];
                                        @endphp
    ...
    <!-- Modal -->
    @include('alimentacao_quantitativos.form')
@endsection

@section('script')
    <!-- scripts_alimentacao_quantitativos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_alimentacao_quantitativos.js')}}"></script>
@endsection
