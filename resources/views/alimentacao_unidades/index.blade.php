...
@section('content')
                                    ...
                                    <div class="col-12 col-md-6 float-end">
                                        @php
                                            $selectCampoPesquisar = [
                                                ['value' => 'alimentacao_unidades.name', 'descricao' => 'Unidade']
                                            ];
                                        @endphp
    ...
    <!-- Modal -->
    @include('alimentacao_unidades.form')
@endsection

@section('script')
    <!-- scripts_alimentacao_unidades.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_alimentacao_unidades.js')}}"></script>
@endsection
