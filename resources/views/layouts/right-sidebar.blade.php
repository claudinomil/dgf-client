...
<div class="right-bar">
    <div data-simplebar class="h-100 small">
        ...
        <!-- Desabilitar alguns Estilos de Layouts -->
        <div class="p-4">
            ...
            <div class="form-check form-switch mb-3">
                ...
                <label class="form-check-label" for="layout_style_vertical_scrollable">Menu Vertical</label>
{{--                <label class="form-check-label" for="layout_style_vertical_scrollable">Vertical - Rolável</label>--}}
            ...
            <div class="form-check form-switch mb-3">
                ...
                <label class="form-check-label" for="layout_style_horizontal_boxed_width">Menu Horizontal</label>
