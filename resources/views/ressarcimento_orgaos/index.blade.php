        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-table-crud-ajax :numCols="2" :colsNames="['Nome', 'Responsável', 'Destinatário', 'Ações']" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="name,responsavel,destinatario_pequeno,action">
                </div>
            </div>
        </div>
    </div>
