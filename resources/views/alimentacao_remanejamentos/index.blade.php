...
@section('title') Remanejamentos @endsection
...
@section('content')
                                    ...
                                    <div class="col-12 col-md-6 float-end">
                                        @php
                                            $selectCampoPesquisar = [
                                                ['value' => 'alimentacao_remanejamentos.name', 'descricao' => 'Remanejamento']
                                            ];
                                        @endphp
    ...
    <!-- Modal -->
    @include('alimentacao_remanejamentos.form')
@endsection

@section('script')
    <!-- scripts_alimentacao_remanejamentos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_alimentacao_remanejamentos.js')}}"></script>
@endsection
