                        ...
                        <fieldset>
                            ...
                            <div class="row mt-4">
                                <div class="form-group col-12 col-md-6 pb-3">
                                    <label class="form-label text-success pb-3">Dashboards</label>

                                    @foreach ($dashboards as $dashboard)
                                        @php
                                            $descricao = '';
                                            if ($dashboard['descricao'] != '') {$descricao = ' ('.$dashboard['descricao'].')';}
                                        @endphp
                                        ...
                                        <div class="col-12">
                                            <div class="form-check form-checkbox-outline form-check-success mb-3">
                                                ...
                                                <label class="form-check-label" for="dashboard_{{ $dashboard['id'] }}">{{ $dashboard['dashboard_agrupamento'].' - '.$dashboard['name'].$descricao }}</label>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
