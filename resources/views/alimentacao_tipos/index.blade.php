...
@section('content')
                                    ...
                                    <div class="col-12 col-md-6 float-end">
                                        @php
                                            $selectCampoPesquisar = [
                                                ['value' => 'alimentacao_tipos.name', 'descricao' => 'Tipo']
                                            ];
                                        @endphp
    ...
    <!-- Modal -->
    @include('alimentacao_tipos.form')
@endsection

@section('script')
    <!-- scripts_alimentacao_tipos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_alimentacao_tipos.js')}}"></script>
@endsection
