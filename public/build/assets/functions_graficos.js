 ...
 */
function cg_card_modelo_3({titulo_tooltip=false, titulo=false, height=false, dados=false, menu=false, div_id=false}) {
    return new Promise(function(resolve, reject) {
        var retorno = '';
        ...
        if (dados) {
            dados.forEach(function (item) {
                ...
                retorno += '        <h5 class="font-size-14 mb-1">' + item.descricao + '</h5>';
                ...
                retorno += '        <h5 class="mb-0">' + item.porcentagem + ' %</h5>';
                retorno += '    </td>';
                retorno += '</tr>';
            });
        }
