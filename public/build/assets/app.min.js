...
(function ($) {
    ...
    function updateThemeSettingMode(id) {
        ...
        if ($("#layout_mode_light").prop("checked") == true && id === "layout_mode_light") {
            ...
            $("#bootstrap-style").attr('href', url + 'build/assets/bootstrap.css');
            $("#app-style").attr('href', url + 'build/assets/app.css');
            ...
            $("#bootstrap-style").attr('href', url + 'build/assets/bootstrap-dark.css');
            $("#app-style").attr('href', url + 'build/assets/app-dark.css');
    ...
    function updateRegisterUser() {
        ...
        if (xmode != '' && xstyle != '') {
            ...
            $.ajax({
                data: '',
                url: url+'users/edit/modestyle/'+xmode+'/'+xstyle+'/'+$('#layout_user_id').val(),
                type: "POST",
                dataType: "json"
            });
        }
