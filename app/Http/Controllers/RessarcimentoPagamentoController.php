                    ...
                    if ($arquivoExtensao == $extensao) {
                        ...
                        if ($arquivoTamanho <= $tamanho_maximo) {
                            ...
                            foreach ($excelData as $registro) {
                                ...
                                if ($linha == 0) { //fazer uma única vez
                                    $referencia_militares_ids_func = Http::get(env('PASSPORT_API_URL') . 'api/ressarcimento_pagamentos/referencia_militares_ids_func/'.$request['ressarcimento_pagamento_referencia']);
                                    ...
                                    if ($importar_registro === true) {
                                        $response = Http::post(env('PASSPORT_API_URL') . 'api/ressarcimento_pagamentos/importar/dados',
                                            [
                                                ...
                                                'ferias' => $linhaDados['FÉRIAS'],
                                                'raio_x' => $linhaDados['RAIOX'],
                                                'trienio' => $linhaDados['TRIÊNIO'],
