...
class Button extends Component
{
    ...
    public function render()
    {
        ...
        if ($this->op == 22) {
            ...
            $this->dataBsToggle = "tooltip";
            $this->dataBsPlacement = "top";
            $this->title = 'Importar Pagamento';
            $this->imageAwesome = "fa fa-file-import label-icon";
            $this->label = 'Importar Pagamento';
        }
        ...
        if ($this->op == 23) {
            ...
            $this->dataBsToggle = "tooltip";
            $this->dataBsPlacement = "top";
            $this->title = 'Importar Militares';
            $this->imageAwesome = "fa fa-file-import label-icon";
            $this->label = 'Importar Militares';
        }
